class Employee:
    ...
    def hash(self, first_name, second_name, gender):
        self.result_hash = first_name + second_name + gender
        return self.result_hash
    
    def __generate_employee_id(self):
        return Employee.hash(self, self.first_name, self.second_name, self.gender)
